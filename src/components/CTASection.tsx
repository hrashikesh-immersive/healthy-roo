  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#F4F7F6] py-16 lg:py-24 min-h-[500px] flex items-center justify-center">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="hidden lg:block absolute left-[3%] xl:left-[3%] top-1/2 -translate-y-[55%] -rotate-[15deg] w-[220px] h-[220px] xl:w-[260px] xl:h-[260px] rounded-[2rem] overflow-hidden shadow-xl border-4 border-white">
          <img
            src={aboutImg}
        ...
        <div className="flex flex-col items-center justify-center text-center max-w-[650px] mx-auto px-4 py-8">
          <span className="text-primary font-[500] text-base mb-5 ">
            Call-to-action
          </span>

          <h2 className="text-3xl md:text-[2.5rem] lg:text-4xl font-[500] text-foreground leading-[1.2] mb-8 ">
            From freshers to experienced
            individuals, all have a chance to evolve
            at HealthyRoo. Here's what it looks like
            working at HealthyRoo.
          </h2>

          <button
            onClick={openPopup}
            className="bg-primary text-primary-foreground font-semibold px-9 py-3.5 rounded-full hover:bg-primary/90 transition-colors shadow-sm cursor-pointer border-none text-base"
          >
            Get Started Now
          </button>
        </div>
