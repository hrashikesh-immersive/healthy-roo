    ...
    <section className="py-20 lg:py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-[1240px]">
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
          ...
          <div className="flex-1 lg:max-w-[450px] z-10 w-full pt-4">
            <h2 className="text-4xl md:text-5xl lg:text-[54px] font-black text-foreground mb-4 leading-[1.1]">
              How it works
            </h2>
            <p className="text-foreground/70 text-base leading-relaxed mb-12 max-w-[400px]">
            ...
            <div className="relative space-y-10">
              ...
              {steps.map((item) => (
                <div key={item.num} className="flex items-start gap-8 group">
          ...
          <div className="flex-1 relative w-full lg:mt-0 z-10">
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden aspect-[4/3] lg:aspect-auto lg:h-[540px] shadow-2xl border-4 border-white transform transition-transform hover:scale-[1.01]">
              <img 
                src={howItWorksNurse} 
            ...
            <div className="absolute -bottom-1 -left-1 w-[260px] h-[110px] bg-white rounded-tr-[3.5rem] rounded-bl-[2.5rem] z-20 flex items-center justify-center pr-6 pt-6">
            ...
            <div className="absolute -bottom-8 -right-4 lg:-right-8 bg-[#2B569A] rounded-2xl text-white py-8 px-10 flex items-center gap-10 shadow-2xl z-30 min-w-[340px] transform transition-transform hover:scale-105">
