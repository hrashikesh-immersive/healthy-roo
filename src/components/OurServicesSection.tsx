  ...
  <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 animate-in fade-in duration-700 max-w-[1200px] mx-auto px-4 lg:px-0">
    ...
    <div className="flex-1 lg:max-w-xl">
      <div className="relative inline-block mb-1 group">
        <h3 className="text-4xl lg:text-5xl font-[500] text-foreground leading-none ">Health Assessments</h3>
      ...
      <p className="text-[#EE1D26] font-[500] text-lg mb-6 leading-none uppercase ">Ensuring Well-Being for Your School</p>

      <div className="space-y-6 text-foreground/70 text-base leading-relaxed mb-10">
        <p>Bringing preventive healthcare directly into schools with 70+ globally recommended health parameters screened by experts.</p>
        <p>Our comprehensive health assessments eliminate the need for clinic visits, organizing everything on‑campus for maximum convenience.</p>
      </div>
      ...
      <ul className="grid grid-cols-1 gap-5 mb-10">
        {[
          ...
          "ENT (Ear, Nose, Throat) Assessment",
          "Growth Tracking & BMI",
          "Anthropometric Assessment"
        ].map((item) => (
          <li key={item} className="flex items-center gap-4 text-foreground font-[500] text-sm uppercase  group cursor-default">
      ...
      <button
        onClick={onContact}
        className="bg-[#EE1D26] text-white font-[500] px-12 py-5 rounded-full uppercase st text-sm hover:brightness-110 transition-all shadow-xl hover:-translate-y-1 active:translate-y-0"
      >
        Book Demo
      </button>
    </div>
  ...
  <div className="space-y-32 py-10 animate-in slide-in-from-bottom-4 duration-700">
    ...
    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
      ...
      <div className="flex-1 relative group">
        ...
        <div className="absolute bottom-[-30px] right-[-20px] w-32 h-12 bg-black text-white flex items-center justify-center font-[500] text-sm rounded shadow-lg z-20">
          Health Hubs
        </div>
      ...
      <div className="flex-1">
        <h2 className="text-4xl md:text-5xl font-[500] leading-none mb-2 text-foreground er uppercase">On-Campus Care</h2>
        <h3 className="text-lg md:text-xl font-[500] text-foreground/80 mb-6 md:mb-8 uppercase st leading-none">Continuous Medical Support</h3>
        <p className="text-muted-foreground leading-relaxed mb-8 text-base">We deploy qualified nurses and doctors directly into schools to provide continuous medical support and emergency care, backed by insurance and hospital partnerships.</p>
        <div className="space-y-4">
          <h4 className="text-primary font-[500] text-lg uppercase">Core Benefits</h4>
          <ul className="space-y-3">
            {["Nurses & Doctors in Schools", "Continuous Medical Staff Support", "Ambulance & Emergency Coordination", "Insurance + Hospital Partnerships"].map(item => (
              <li key={item} className="flex items-center gap-3 text-foreground font-[500] text-sm">
    ...
    <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24">
      ...
      <div className="flex-1">
        <h2 className="text-4xl md:text-5xl font-[500] leading-none mb-2 text-foreground er uppercase">Medical Staff</h2>
        <h3 className="text-lg md:text-xl font-[500] text-foreground/80 mb-6 md:mb-8 uppercase st leading-none">School Nurse and Doctor</h3>
        ...
        <div className="space-y-12">
          <div className="flex items-start gap-5">
            ...
            <div>
              <h4 className="font-[500] text-foreground mb-2 text-lg uppercase leading-tight">Qualified and Experienced Nurse or Doctor</h4>
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              <h4 className="font-[500] text-foreground mb-2 text-lg uppercase leading-tight">Backup</h4>
    ...
    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
      ...
      <div className="flex-1">
        <h2 className="text-4xl md:text-5xl font-[500] leading-none mb-2 text-foreground er uppercase">Insurance</h2>
        <h3 className="text-lg md:text-xl font-[500] text-foreground/80 mb-6 md:mb-8 uppercase st leading-none">Ensure Year Round Protection</h3>
        ...
        <div className="space-y-4">
          <h4 className="text-primary font-[500] text-lg uppercase">Key Inclusion</h4>
          <ul className="space-y-3">
            {[
    ...
    <div className="flex justify-center pt-8">
      <button
        onClick={onContact}
        className="bg-primary text-white font-[500] px-12 py-5 rounded-full uppercase  text-sm hover:bg-primary/80 transition-all shadow-2xl"
      >
        Connect With Us
      </button>
    </div>
  ...
  return (
    <div className="space-y-32 py-10 animate-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        <div className="flex-1">
          <h2 className="text-4xl md:text-5xl font-[500] leading-none mb-2 text-foreground er uppercase">Health Education</h2>
          <h3 className="text-lg md:text-xl font-[500] text-foreground/80 mb-6 md:mb-8 uppercase st leading-none">THE HEALTHSETGO CHANGEMAKERS PROGRAM</h3>
          ...
          <ul className="space-y-4 mb-10">
            {[
              ...
              <li key={item} className="flex items-start gap-3 text-foreground font-[500] text-sm">
          ...
          <div className="mb-12">
            <h4 className="text-primary font-[500] text-lg uppercase mb-8">THE CLUBS WILL FOCUS ON 4 THEMES</h4>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={theme.name} className="flex flex-col items-center gap-4">
                  ...
                  <span className="text-xs font-[500] text-foreground text-center leading-tight r">{theme.name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <button 
            onClick={onContact}
            className="bg-black text-white font-[500] px-10 py-4 rounded-full uppercase st text-sm hover:bg-gray-800 transition-all shadow-xl"
          >
            Explore the Program
          </button>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-24 pt-20 border-t border-muted/20">
        ...
        <div className="flex-1 w-full order-1 lg:order-2">
          <h2 className="text-4xl md:text-5xl font-[500] leading-none mb-2 text-foreground er uppercase">Workshops</h2>
          <h3 className="text-lg md:text-xl font-[500] text-foreground/80 mb-6 md:mb-8 uppercase st leading-none">EMPOWERING HOLISTIC WELLNESS</h3>
          ...
          <button 
            onClick={onContact}
            className="bg-black text-white font-[500] px-10 py-4 rounded-full uppercase st text-sm hover:bg-gray-800 transition-all mb-16 shadow-lg"
          >
            Schedule a Workshop
          </button>
            ...
            {[
              ...
              <div key={group.id} className="border-b border-muted/10 last:border-0 overflow-hidden">
                <button
                  ...
                  className="w-full flex items-center justify-between py-5 text-primary font-[500] text-sm uppercase st text-left transition-colors hover:text-black"
                >
                  <span>{group.id}</span>
...
const CommunityWellnessTab = ({ onContact }: { onContact: () => void }) => (
  <div className="space-y-32 py-10 animate-in slide-in-from-bottom-4 duration-700">
    ...
    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
      <div className="flex-1">
        <h2 className="text-4xl md:text-5xl font-[500] leading-none mb-2 text-foreground er uppercase">In-School Vaccination Program</h2>
        <h3 className="text-lg md:text-xl font-[500] text-foreground/80 mb-6 md:mb-8 uppercase st leading-tight">CONVENIENCE, COMFORT, AND CARE – ALL UNDER ONE ROOF!</h3>
        ...
        <div className="space-y-6">
          <h4 className="text-primary font-[500] text-lg uppercase">HOW IT WORKS</h4>
            ...
            {[
              ...
              <li key={item.title} className="flex items-start gap-3">
                ...
                <p className="text-sm leading-relaxed">
                  <span className="font-[500] text-foreground">{item.title}:</span> <span className="text-muted-foreground">{item.desc}</span>
                </p>
              </li>
            ))}
          </ul>
    ...
    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 pt-20 border-t border-muted/20">
      ...
      <div className="flex-1">
        <h2 className="text-5xl font-[500] leading-none mb-2 text-foreground er uppercase">Diagnostic Services</h2>
        <h3 className="text-xl font-[500] text-foreground/80 mb-8 uppercase st leading-none">PRIORITIZE THE HEALTH AND WELL-BEING OF YOUR SCHOOL STAFF</h3>
        <p className="text-muted-foreground text-base leading-relaxed mb-10 max-w-xl">
    ...
    <div className="flex justify-center pt-20">
      <button
        onClick={onContact}
        className="bg-primary text-white font-[500] px-12 py-5 rounded-full uppercase  text-sm hover:bg-primary/80 transition-all shadow-2xl border-4 border-transparent hover:border-primary/20"
      >
        Connect With Us
      </button>
    </div>
    ...
    <section id="services" className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-4 lg:px-8 max-w-[1280px]">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-[500] text-foreground mb-4">Our Services</h2>
        ...
        <div className="flex flex-nowrap md:flex-wrap items-center justify-start md:justify-center gap-x-8 md:gap-x-12 mb-20 border-b border-gray-100/50 overflow-x-auto pb-4 scrollbar-hide">
          {tabs.map((tab) => (
            <button
              ...
              className={`pb-4 text-sm md:text-base font-semibold  transition-all relative whitespace-nowrap shrink-0 ${activeTab === tab
        ...
        <div className="min-h-[600px] relative">
          <AnimatePresence mode="wait">
            ...
            >
              {activeTab === "Health Assessment" && <HealthAssessmentTab onContact={openPopup} />}
              {activeTab === "Health Safety" && <HealthSafetyTab onContact={openPopup} />}
              {activeTab === "Health Education" && <HealthEducationTab onContact={openPopup} />}
              {activeTab === "Community Wellness" && <CommunityWellnessTab onContact={openPopup} />}
            </motion.div>
          </AnimatePresence>
        </div>
      </div>
