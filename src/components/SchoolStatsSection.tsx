    ...
    <section className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-4 lg:px-8 max-w-[1100px]">
        ...
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold text-[#111] leading-tight tracking-tight">
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-baseline gap-1 mt-1">
                  <span className="text-5xl md:text-6xl font-bold text-[#111] leading-none tracking-tight">
                    {stat.value}
                  </span>
                  <span className="text-xl font-bold text-[#111] leading-none">%</span>
                </div>
