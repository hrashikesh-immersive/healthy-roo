  ...
  return (
    <section className="py-20 lg:py-28 bg-[#F4F7F6] overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 max-w-[1300px]">
        ...
        >
          <h2 className="text-3xl lg:text-4xl font-[500] text-[#111] mb-5 leading-tight ">
        ...
        <div className="relative w-full px-4 lg:px-8">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="absolute left-0 lg:left-0 top-1/2 md:top-[35%] lg:top-1/2 -translate-y-1/2 w-16 h-16 bg-white hover:bg-gray-100 transition-colors rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.08)] z-30 cursor-pointer border border-[#EBEBEB]"
          >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 relative z-10 px-0 lg:px-6">
            ...
            <motion.div
              ...
              className="flex-1 flex flex-col sm:flex-row items-center sm:items-start gap-6 lg:gap-8 min-w-0"
            >
              <div className="w-[180px] h-[180px] lg:w-[220px] lg:h-[220px] shrink-0 rounded-full overflow-hidden shadow-md group">
                <img src={testImg1} alt="Melbourne High School Testimonial" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
              </div>
              <div className="flex-1 pt-2 sm:pt-6 text-center sm:text-left min-w-0">
                <h3 className="text-2xl lg:text-3xl font-[500] text-[#111] mb-4 ">
                  Melbourne High School
                </h3>
                <p className="text-[#2B2B2B] text-sm lg:text-base leading-loose font-medium italic">
            ...
            >
              <div className="w-[180px] h-[180px] lg:w-[220px] lg:h-[220px] shrink-0 rounded-full overflow-hidden shadow-md group">
                <img src={testImg2} alt="Baulkham Hills High School Testimonial" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
              </div>
              <div className="flex-1 pt-2 sm:pt-6 text-center sm:text-left min-w-0">
                <h3 className="text-2xl lg:text-3xl font-[500] text-[#111] mb-4 ">
          ...
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="absolute right-0 lg:right-0 top-1/2 md:top-[35%] lg:top-1/2 -translate-y-1/2 w-16 h-16 bg-white hover:bg-gray-100 transition-colors rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.08)] z-30 cursor-pointer border border-[#EBEBEB]"
          >
