...
import whyHealthSmilingGirl from "@/assets/why-health-smiling-girl.png";
      ...
      <div className="container mx-auto px-4 lg:px-20">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
              ...
              <div className="absolute bottom-[5%] right-0 w-[65%] h-[60%] z-30 group">
                ...
                >
                  <img 
                    src={whyHealthSmilingGirl} 
                    alt="Smiling girl" 
                    className="absolute w-[180%] h-[180%] max-w-none left-[-55%] top-[-30%] object-cover transition-transform duration-500 group-hover:scale-[1.03]"
                  />
                </div>
              </div>
          ...
          <div className="flex-1 order-1 lg:order-2">
            <h2 className="text-4xl md:text-6xl font-black text-foreground leading-[1.1] tracking-tight mb-4">
              Why Health, Why now
            </h2>
