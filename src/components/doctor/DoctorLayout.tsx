    ...
    <div className="flex min-h-screen bg-[#F8F9FA] font-sans">
      ...
      <main className={cn(
        ...
        <header className={cn(
          ...
          <div id="header-filter-container" className="flex-grow mr-4 lg:mr-8 flex items-center">
            {/* The default search was here, removed to allow DoctorDashboard to portal its filters */}
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-6 border-l border-slate-100">
              <div className="text-right">
                <p className="text-sm font-bold text-slate-900">Dr. Pal Testing</p>
                <p className="text-[10px] font-bold text-primary uppercase">Chief Physician</p>
              </div>
