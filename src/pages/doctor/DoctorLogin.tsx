...
const DoctorLoginPage = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      if (email === "doctor@healthyroo.com" && password === "password") {
        toast.success("Welcome back, Dr. Pal!");
          ...
          >
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-[2.5rem] shadow-2xl">
              ...
              <h1 className="text-4xl md:text-5xl font-[500] uppercase er leading-[0.9] mb-6">
                Empowering <br />
                <span className="text-primary italic">Clinical</span> Excellence.
              </h1>
              <p className="text-white/70 text-lg font-medium leading-relaxed mb-8">
                Access your assigned schools, review student health data, and provide expert medical assessments on our unified platform.
              </p>
              <div className="flex items-center gap-4 pt-6 border-t border-white/10">
                ...
                <p className="text-xs font-[500] uppercase st opacity-60">Over 500+ Doctors Network</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="flex-grow flex items-center justify-center px-6 md:px-20 lg:px-32 py-12">
          ...
          >
            <div className="mb-12">
              ...
              <p className="text-muted-foreground font-medium">Log in to review assigned school reports.</p>
            </div>

            <form className="space-y-6" onSubmit={handleLogin}>
              <div>
                <label className="block text-xs font-[500] uppercase  mb-3 text-muted-foreground">Doctor Email Address</label>
                <div className="relative group">
                  ...
                  <input
                    type="email"
                    placeholder="doctor@healthyroo.com"
                    value={email}
            ...
            <p className="mt-12 text-center text-sm font-[500] text-muted-foreground">
              Not registered as a doctor? <Link to="/contact" className="text-primary hover:underline">Contact us</Link>
            </p>
          </motion.div>
        </div>
